...
Clicked Next
Clicked Create
Once the instance is created, note the public IP Address (I will use 200.200.200.200 for this example)
...
ping 200.200.200.200 (if this fails, your machine is not up or you messed up on the previous steps)
ssh -i "/path-to-key/ssh-key-2026-xx-xx.key" opc@200.200.200.200
...
On termianl typed ssh -i /path_to_key/ssh-key-2026-xx-xx-xx.key opc@200.200.200.200 -p 64295
